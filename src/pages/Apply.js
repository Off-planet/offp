...
import Grimnotes from "../font/Grimnotes.ttf";
...
const theme = createTheme({
  ...
  components: {
    MuiCssBaseline: {
      styleOverrides: `
        @font-face {
          font-family: 'Grimnotes';
          font-style: normal;
          font-display: swap;
          font-weight: 400;
          src: local('Grimnotes'), local('Grimnotes'), url(${Grimnotes}) format('truetype');
                ...
                {pageNumber === 7 && (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        What was the first album you ever bought, or first
